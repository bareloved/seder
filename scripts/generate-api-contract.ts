...
const interfaces: ContractInterface[] = [
  {
    ...
    fields: [
      ...
      { name: "rollingJobId", type: "string | null", optional: true },
      { name: "detachedFromTemplate", type: "boolean", optional: true },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "description", type: "string", optional: false },
      { name: "clientId", type: "string | null", optional: false },
      { name: "clientName", type: "string", optional: false },
      { name: "categoryId", type: "string | null", optional: false },
      { name: "amountGross", type: "string", optional: false },
      { name: "vatRate", type: "string", optional: false },
      { name: "includesVat", type: "boolean", optional: false },
      { name: "defaultInvoiceStatus", type: "InvoiceStatus", optional: false },
      { name: "cadence", type: "Cadence", optional: false },
      { name: "startDate", type: "string", optional: false },
      { name: "endDate", type: "string | null", optional: false },
      { name: "sourceCalendarRecurringEventId", type: "string | null", optional: false },
      { name: "sourceCalendarId", type: "string | null", optional: false },
  ...
  },
  {
    name: "Cadence",
    fields: [
      { name: "kind", type: "'daily' | 'weekly' | 'monthly'", optional: false },
      { name: "interval", type: "number", optional: false },
      { name: "weekdays", type: "number[]", optional: true },
      { name: "dayOfMonth", type: "number", optional: true },
    ],
  },
  {
    name: "Category",
