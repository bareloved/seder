      ...
      <TableRow className="group bg-gradient-to-l from-emerald-50/60 via-emerald-50/40 to-white dark:from-emerald-900/20 dark:via-emerald-900/10 dark:to-slate-900 border-b-2 border-dashed border-emerald-300 dark:border-emerald-700/50 hover:bg-emerald-50/80 dark:hover:bg-emerald-900/30 print:hidden transition-colors">
        ...
        <Input
          ...
          onChange={(e) => setQuickAddDescription(e.target.value)}
              ...
              className="h-9 w-full text-sm border-slate-200 dark:border-border bg-white dark:bg-card focus:bg-white dark:focus:bg-muted focus:border-slate-400 focus:ring-0 focus-visible:ring-0 focus-visible:ring-offset-0 placeholder:text-slate-400 dark:placeholder:text-slate-500 rounded-lg transition-shadow"
        ...
        />
            ...
            <div className="absolute left-2 top-1/2 -translate-y-1/2 flex items-center gap-1 text-[10px] text-slate-400 dark:text-slate-500 pointer-events-none hidden sm:flex opacity-0 transition-opacity group-hover:opacity-100 focus-within:opacity-100">
              ...
              <span>
                <span className="bg-slate-100 dark:bg-card px-1 py-0.5 rounded text-[9px] font-mono">Tab</span>
                {" "}הבא
                <span className="mx-1">•</span>
                <span className="bg-slate-100 dark:bg-card px-1 py-0.5 rounded text-[9px] font-mono">Enter</span>
                {" "}שמור
              </span>
            </div>
          </div>
        ...
        <div className="relative">
          ...
          <Input
            ...
            onKeyDown={handleQuickAddKeyDown}
            placeholder="0"
              className="h-9 w-full pl-8 text-sm border-slate-200 dark:border-border bg-white dark:bg-card focus:bg-white dark:focus:bg-muted focus:border-slate-400 focus:ring-0 focus-visible:ring-0 focus-visible:ring-offset-0 text-right placeholder:text-slate-400 rounded-lg transition-shadow"
            dir="rtl"
          />
        </div>
      </TableCell>
        ...
        <div className="relative w-full">
          <Input
            ...
            onKeyDown={handleQuickAddKeyDown}
            placeholder="שם לקוח"
              className="h-9 w-full text-sm border-slate-200 dark:border-border bg-white dark:bg-card focus:bg-white dark:focus:bg-muted focus:border-slate-400 focus:ring-0 focus-visible:ring-0 focus-visible:ring-offset-0 placeholder:text-slate-400 rounded-lg transition-shadow"
          />
            {/* Client Autocomplete dropdown */}
          {showClientSuggestions && filteredClients.length > 0 && (
              <div className="absolute z-10 top-full mt-1 w-full bg-white dark:bg-card rounded-lg shadow-lg border border-slate-200 dark:border-border py-1 overflow-hidden">
        ...
        <TableCell className="py-3 pr-3">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="outline"
                className="h-9 w-full text-sm border-slate-200 dark:border-border bg-white dark:bg-card focus:border-slate-400 focus:ring-0 focus-visible:ring-0 focus-visible:ring-offset-0 rounded-lg transition-shadow text-right justify-between font-normal px-3"
              >
        ...
        <TableCell className="py-3">
          <Badge className="text-[10px] px-2 py-0.5 bg-slate-100 text-slate-500 border border-slate-200 dark:bg-card dark:border-border">
          בוצע
        </Badge>
      </TableCell>
        <TableCell className="py-3">
