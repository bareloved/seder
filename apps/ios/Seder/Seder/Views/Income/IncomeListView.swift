...
struct IncomeListView: View {
    ...
    var body: some View {
        ...
        .animation(.easeIn(duration: 0.3), value: isInitialLoad)
        ...
        .task {
            ...
            async let clients: () = clientsVM.loadClients()
            async let nudges: () = nudgeVM.fetchNudges()
            _ = await (entries, categories, clients, nudges)
